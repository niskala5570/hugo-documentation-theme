...
`\move(<x1>,<y1>,<x2>,<y2>)` `\move(<x1>,<y1>,<x2>,<y2>,<t1>,<t2>)`

Tanda `\move` sama seperti tanda `\pos`, iaitu mendudukkan baris sari kata,
bezanya ianya tanda `\move` akan menggerakkan sari kata.<br>
